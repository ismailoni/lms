...
const ChaptersSidebar = () => {
  ...
  const completedTotal = userProgress?.progressData?.sections.reduce(
    (total, section) =>
      total + section.chapters.filter((c) => c.completed).length,
    0
  );
            ...
            <SidebarMenu className="space-y-3">
              {course?.sections?.map((section, index) => {
                const sectionProgress =
                  userProgress?.progressData?.sections.find(
                    (s) => s.sectionId === section.sectionId
                  );
                const completedChapters =
                  sectionProgress?.chapters.filter((c) => c.completed).length ??
                  0;
                ...
                const sectionProgressPercentage =
                  section.chapters.length > 0
                    ? (completedChapters / section.chapters.length) * 100
                    : 0;
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col">
                          ...
                          <span className="text-white font-semibold truncate text-base mt-1">
                            {section.sectionTitle}
                          </span>
                        </div>
                              ...
                              <SidebarMenuSubItem key={chapter.chapterId}>
                                <SidebarMenuSubButton
                                  ...
                                  className={cn(
                                    ...
                                    isCurrentChapter &&
                                      "bg-gradient-to-r from-blue-600/30 to-purple-600/30 border-blue-500/50 shadow-xl shadow-blue-500/20",
                                    isChapterCompleted &&
                                      !isCurrentChapter &&
                                      "bg-gradient-to-r from-green-600/15 to-emerald-600/15 border-green-500/30",
                                    !isChapterCompleted &&
                                      !isCurrentChapter &&
                                      "bg-gradient-to-r from-gray-800/60 to-gray-700/60 border-gray-600/30 hover:border-gray-500/50"
                                  )}
                                >
                                  ...
                                  <div className="flex-shrink-0 relative">
                                    {isChapterCompleted ? (
                                      ...
                                      <div
                                        ...
                                        title="Mark as complete"
                                      >
                                        <span className="group-hover/icon:hidden">
                                          {idx + 1}
                                        </span>
                                  ...
                                  {isCurrentChapter && (
                                    <div className="flex items-center gap-3">
                                      ...
                                      <button
                                        ...
                                        title={
                                          isChapterCompleted
                                            ? "Mark as incomplete (Ctrl+C)"
                                            : "Mark as complete (Ctrl+C)"
                                        }
                                      >
                                        {isChapterCompleted
                                          ? "✓ Done"
